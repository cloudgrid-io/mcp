...
try {
  ...
  check("401 create → sign-in-only guidance (no anonymous fallback)", /grid_login/.test(errorGuidance({ status: 401, isEdit: false }) || "") && !/anon: true/.test(errorGuidance({ status: 401, isEdit: false }) || ""));
