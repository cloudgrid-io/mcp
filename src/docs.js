...
function createDocsServer() {
  ...
  // Naming cleanup (spec §6): the docs tools move to the grid_* family. Both
  ...
  //   search_cloudgrid_documentation → grid_search_docs
  //   cloudgrid_quickstart_guide     → grid_quickstart
