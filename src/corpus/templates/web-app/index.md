# Template: web-app (static)

A single self-contained HTML web-app. **No infrastructure** — no database, no backend,
...
`grid_fetch("template", "web-app")` and fill in the user's content.
