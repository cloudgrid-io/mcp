# Template: report (static)

A single self-contained HTML report. **No infrastructure** — no database, no backend,
...
`grid_fetch("template", "report")` and fill in the user's content.
