# Template: portfolio (static)

A single self-contained HTML personal / freelancer portfolio: a hero intro, an about section, a skills list, a projects grid, and a contact section. **No infrastructure** — no database, no backend, no `needs:`.
...
`grid_fetch("template", "portfolio")` and fill in the user's content.
